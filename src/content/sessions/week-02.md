---
title: Find what the average hides
description:
  Work the Office of Everything's own ticket log against its "average wait"
  memo, then apply the same check to the system you are tracking yourself.
week: 2
date: 2027-03-01
teachers:
  - idris-fenn
spec:
  ...
  - you have named, in writing, which kind of request the memo's average is
    quietly averaging away
  - you have taken a second timed observation of your own real waiting
    system, this time recording individual wait times rather than a general
    impression
---
...
Bring your own system's data from week 1: even a rough sense of "this person
waited about this long" is enough to start.
...
say so — that is itself a finding, and you'll get another chance to look
next week.
